#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
# Wind Turbine Digital Twin - Prediction Script using Saved Random Forest Model (Direct Input)                # # <-- Updated Title
# By [Wind Turbine Digital Twins]                                                                               #
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
# Description:                                                                                                  #
# This script loads a previously trained Random Forest pipeline (saved as a .pkl file)                          # # <-- Updated Description
...
# --- File Paths ---
# *** IMPORTANT: Specify the correct path to your saved Random Forest model file ***
# Based on the training script naming convention, assuming weather and linaccel were included:
saved_model_filename = 'rpm_volt_pow_curr_multi_rf_model_fanflags_weather_linaccel.pkl' # <--- VERIFY THIS FILENAME
...
# output_predictions_filename = 'rf_single_prediction_output.csv'
...
# 3. Load Model                                                                                                   #
#-----------------------------------------------------------------------------------------------------------------#
print(f"Loading saved Random Forest model pipeline from: {saved_model_filename}") # Updated print
...
# 5. Make Prediction                                                                                              #
#-----------------------------------------------------------------------------------------------------------------#
print("\nMaking prediction using the loaded Random Forest model...") # Updated print
